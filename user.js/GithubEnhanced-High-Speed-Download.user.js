...
(function () {
    ...
    var aria2c = 'aria2c -d . --check-certificate=false --max-connection-per-server=10 --max-concurrent-downloads=20 --split=20 --min-split-size=512K --continue=true --optimize-concurrent-downloads=true --connect-timeout=5 --timeout=10 --lowest-speed-limit=5K --allow-overwrite=true --disk-cache=64M --max-tries=5 --retry-wait=5 ';
