...
(function () {
    ...
    var aria2c = 'aria2c --check-certificate=false -x 15 -j 10 -s 100 -c --connect-timeout=10 --timeout=10 --lowest-speed-limit=1K --allow-overwrite=true ';
    const download_url = [
