...
// @version      2024.1.10.0956
// @author       沙漠之子
// @license      GPL-3.0
// @match        https://github.com/*
// @match        https://gist.github.com/*
// @exclude      https://github.com/*/edit/*
// @require      https://github.com/anaer/UserScript/raw/main/user.js/github-chinese.locales.js?_v=2024.1.9.1757
// @run-at       document-end
    ...
    function traverseNode(node) {
        ...
        if (node.nodeType === Node.ELEMENT_NODE) { // 元素节点处理
            ...
            if (["INPUT", "TEXTAREA"].includes(node.tagName)) { // 输入框 按钮 文本域
                ...
                // 多文件比较 不翻译
                if (node.hasAttribute('data-details-container-group') && node.getAttribute('data-details-container-group') === 'file'){
                    return;
                }
            } else if (node.tagName === 'NAV') {
                // 面包屑导航不进行翻译
                if (node.hasAttribute('data-testid') && node.getAttribute('data-testid') === 'breadcrumbs'){
                    return;
                }
            }
