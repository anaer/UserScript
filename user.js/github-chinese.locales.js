    ...
    "static": { // 静态翻译
        ...
        // 拉取请求 --> 更改的文件 标签卡 /<user-name>/<repo-name>/pull/<id>/files
            ...
            "Changes from": "更改自",
                ...
                // "You haven‘t reviewed this pull requeste": "您尚未审查过此拉取请求",
...
I18N.zh["repository/compare"] = { // 仓库 - 比较并创建拉取请求
    "static": { // 静态翻译
        ...
        // 变更比较 页面 /<user-name>/<repo-name>/compare
            ...
            "Learn more about diff comparisons here": "在这里了解有关差异比较的更多信息",
        ...
        // /<user-name>/<repo-name>/compare/<branch>...<branch-1>
            ...
            "learn more about diff comparisons": "了解有关差异比较的更多信息",
            // "base fork:": "基复刻：",
...
I18N.zh["search"] = { // 搜索页面
    "static": { // 静态翻译
        ...
        // 高级搜索 https://github.com/search/advanced >>>>>>>>>>>>>>>>>>>>>>>>
            ...
            "Search": "搜索",
            "Advanced options": "高级选项",
            "From these owners": "作者",
            "In these repositories": "仓库",
            ...
            "With this many stars": "星标数",
            "With this many forks": "复刻数",
            "Of this size": "仓库大小",
            "Pushed to": "推送日期",
            ...
            "Assigned to the users": "受理人",
            "Updated before the date": "更新日期",

            "Users options": "用户选项",
            "With this full name": "全称",
            "From this location": "来自",
            "With this many followers": "粉丝数",
            "With this many public repositories": "公共仓库数",
            "Working in this language": "编程语言",
        ...
        // 代码安全性与分析 /organizations/<org-login>/settings/security_analysis
            ...
            // Dependabot
                ...
                // 对话框
                    ...
                    "Enable Dependabot alerts": "启用 Dependabot 警报",
                    // [/You're about to enable Dependabot alerts on all repositories in ([^ ]+). Alerts require the dependency graph, so we'll also turn that on for all repositories./, "您即将启用 $1 组织中所有仓库上的 Dependabot 警报。Dependabot 警报需要依赖关系图，因此我们还将为所有仓库开启它。"],
